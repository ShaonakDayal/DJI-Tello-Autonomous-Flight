...
# this is just the bound box sizes that openCV uses
faceSizes = [1026, 684, 456, 304, 202, 136, 90]

# These are the values in which kicks in speed up mode, as of now, this hasn't been tested apart from 3,4,5
...
# 
face_cascade = cv2.CascadeClassifier('S:\Tello\cascades\data\haarcascade_frontalface_alt2.xml')
